...
<?php include (TEMPLATEPATH . '/header_2015.php'); ?>
		
			<div id="content" role="main">

						<?php while ($wp_query->have_posts()) : $wp_query->the_post(); ?>
						
						<div id="home_big_content" style="background: url('<?php echo get_post_meta($post->ID, "fondo", true); ?>'); min-height: 735px; max-height: 800px; margin-bottom: 30px; ">
							<div id="navigation">
							<!--
								<ul id="primary_navigation">
									<li><a href="http://www.bestiafestival.com/2013.html">Edición 2013</a></li>
									<li>//</li>
									<li><a href="http://www.bestiafestival.com/">Edición 2014</a></li>
								</ul>
							-->
							...
							<div class="logo_2015">
								<a href="#bestiaLogo" class="logo_secuence"></a>
								<!-- <img src="<?php echo get_post_meta($post->ID, "logo", true); ?>"> -->
								<span style="font-size: 15px;">BESTIA FESTIVAL 3ERA EDICIÓN DEL 4-6 DE DICIEMBRE / CICLO JOHN ZORN MÉXICO</span>
							</div>
										...
										<ul id="main-nav" class="clearfix">
											<li class="toogleEdiciones"><span id="clickEdiciones">Ediciones</span>
												<ul class="ediciones">
													...
													<li><a href="http://bestiafestival.com/" target="_blank">2016</a></li>
												</ul>
											</li>
